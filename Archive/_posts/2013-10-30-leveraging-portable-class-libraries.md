---
ID: 1470
post_title: Leveraging Portable Class Libraries
author: Marc LaFleur
post_date: 2013-10-30 11:52:17
post_excerpt: "Part of a series covering Windows Client development, we continue to work on RMV Awesome - an ironically named Modern UI application for keeping tabs on the Massachusetts Registry of Motor Vehicles. In this article we'll take a step towards cross-platform by introducing Portable Class Libraries."
layout: post
permalink: >
  http://massivescale.com/leveraging-portable-class-libraries/
published: true
panels_data:
  - 'a:0:{}'
views:
