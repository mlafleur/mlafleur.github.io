...
With Azure AD, there are two types of "consent" to consider; User & Admin. Understanding the difference is key to avoiding a surprise `403 - Not Authorized` error when you start calling Microsoft Graph.
...
This page is asking the User to consent to a list of permissions being requested by the application. Once they click "Accept", the application will have permission to execute those activities on the user's behalf.
