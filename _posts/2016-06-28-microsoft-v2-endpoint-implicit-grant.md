...
[caption id="attachment_7681" align="alignnone" width="400"]<img class="size-full wp-image-7681" src="https://massivescale.blob.core.windows.net/blogmedia/2016/06/apps-dev-web-platform.png" alt="App Registration - Web Platform Properties" width="400" height="176" /> App Registration - Web Platform Properties[/caption]
...
&gt; **Scopes**
&gt; Because the Implicit Flow does not do a token exchange, scopes that depend on them such as offline_access and openid will simply be ignored by the Endpoint.
