---
ID: 971
post_title: Basic HTTP Authentication in WinRT
author: Marc LaFleur
post_date: 2012-07-29 22:45:18
post_excerpt: "I'm working with a REST API that requires Basic HTTP Authentication. This is pretty commonplace and something I've done it many times in the past in web and Silverlight applications. WinRT was very similar but (as with everything in WinRT) has its own nuances."
layout: post
permalink: >
  http://massivescale.com/basic-http-authentication-in-winrt/
published: true
views:
  - "7730"
panels_data:
