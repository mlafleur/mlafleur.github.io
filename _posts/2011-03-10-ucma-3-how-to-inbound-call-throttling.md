---
ID: 201
post_title: 'UCMA 3 How-To: Inbound Call Throttling'
author: Marc LaFleur
post_date: 2011-03-10 12:07:46
post_excerpt: "Speech Server included a setting in the Administrator Console for inbound call throttling, simply set it and forget it. Here we'll discus how we can accomplish graceful inbound call throttling with UCMA 3.0."
layout: post
permalink: >
  http://massivescale.com/ucma-3-how-to-inbound-call-throttling/
published: true
